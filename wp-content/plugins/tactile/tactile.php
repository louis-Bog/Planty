...
*/
	...
	function tactile_theme_customizer( $wp_customize ) {
        ...
        //
        $wp_customize->add_panel('tactile_panel', array('title' => esc_html__('Tactile Plugin', 'tactile-menu'),'priority' => 10,));

		//
        // ADD "Header" SECTION TO "TACTILE" PANEL 
        //
		$wp_customize->add_section('tactile_header_section',array('title' => esc_html__('Header','tactile-menu'),'panel' => 'tactile_panel'));
		
		/* absolute positioning */
        $wp_customize->add_setting('tactile_absolute',array('sanitize_callback' => 'sanitize_tactile_absolute',));
        function sanitize_tactile_absolute( $input ) { if ( $input === true ) { return 1; } else { return ''; } }
		$wp_customize->add_control('tactile_absolute',array('type' => 'checkbox','label' => esc_html__('Absolute position','tactile-menu'),'description' => 'When checked, the header will scroll with the page. If left unchecked, the header will remain visible when scrolled.','section' => 'tactile_header_section',));
        ...
        $wp_customize->add_control('tactile_header_color_opacity',array(
            'type' => 'text',
            'label' => esc_html__('Background color opacity','tactile-menu'),
            'description' => esc_html__('Example: 0.5. If left empty, defaults to 1.','tactile-menu'),
        ...
        $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'tactile_header_image',
            array(
				'label' => esc_html__('Header background image','tactile-menu'),
				'description' => esc_html__('Background image appears below the background color; please change background color opacity above to make image visible.','tactile-menu'),
        ...
        function sanitize_tactile_header_pattern( $input ) { if ( $input === true ) { return 1; } else { return ''; } }
		$wp_customize->add_control('tactile_header_pattern',array('type' => 'checkbox','label' => esc_html__('Background as pattern','tactile-menu'),'section' => 'tactile_header_section',));
        ...
        $wp_customize->add_control('tactile_header_image_opacity',array(
            'type' => 'text',
            'label' => esc_html__('Background image opacity','tactile-menu'),
            'description' => esc_html__('Example: 0.5. If left empty, defaults to 1.','tactile-menu'),
            'section' => 'tactile_header_section',
		));
        ...
        //
		$wp_customize->add_section('tactile_logo_section',array('title' => esc_html__('Logo','tactile-menu'),'panel' => 'tactile_panel'));
        ...
        $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'tactile_logo_image',
            array(
                'label' => esc_html__('Logo image','tactile-menu'),
        ...
        $wp_customize->add_control('tactile_logo_text_size',array(
            'type' => 'text',
            'label' => esc_html__('Logo text size (in pixels)','tactile-menu'),
            'description' => esc_html__('Example: 20. If left empty, defaults to 16.','tactile-menu'),
            'section' => 'tactile_logo_section',
		));
        ...
        //
        $wp_customize->add_section('tactile_menu_button_section',array('title' => esc_html__('Menu Button','tactile-menu'),'panel' => 'tactile_panel'));
        
        /* hide main menu button */
        $wp_customize->add_setting('tactile_hide_menu_button',array('sanitize_callback' => 'sanitize_tactile_hide_menu_button',));
        function sanitize_tactile_hide_menu_button( $input ) { if ( $input === true ) { return 1; } else { return ''; } }
		$wp_customize->add_control('tactile_hide_menu_button',array('type' => 'checkbox','label' => esc_html__('Hide menu button','tactile-menu'),'description' => 'When selected, the main menu button (and the drop-down menu) will be hidden.','section' => 'tactile_menu_button_section',));
        ...
        $wp_customize->add_control('tactile_menu_button_animation',array(
            'type' => 'select',
            'label' => esc_html__('Menu button animation','tactile-menu'),
            'section' => 'tactile_menu_button_section',
            'choices' => array(
				'none' => esc_html__('No animation','tactile-menu'),
                'minus' => esc_html__('Minus sign','tactile-menu'),
                'x' => esc_html__('X sign','tactile-menu'),
        ),
		));
        ...
        //
        $wp_customize->add_section('tactile_dropdown_menu_section',array('title' => esc_html__('Drop-Down Menu','tactile-menu'),'panel' => 'tactile_panel'));
        ...
        $wp_customize->add_control('tactile_dropdown_width',array(
            'type' => 'text',
            'label' => esc_html__('Dropdown menu width (in pixels)','tactile-menu'),
            'description' => esc_html__('Example: 500. If left empty, defaults to 300.','tactile-menu'),
        ...
        $wp_customize->add_control('tactile_dropdown_menu_item_size',array(
            'type' => 'text',
            'label' => esc_html__('Dropdown menu item size (in pixels)','tactile-menu'),
            'description' => esc_html__('Example: 12. If left empty, defaults to 16.','tactile-menu'),
            'section' => 'tactile_dropdown_menu_section',
		));
        ...
        $wp_customize->add_control('tactile_dropdown_submenu_item_size',array(
            'type' => 'text',
            'label' => esc_html__('Dropdown submenu item size (in pixels)','tactile-menu'),
            'description' => esc_html__('Example: 12. If left empty, defaults to 16.','tactile-menu'),
            'section' => 'tactile_dropdown_menu_section',
		));
        ...
        //
        $wp_customize->add_section('tactile_search_section',array('title' => esc_html__('Search','tactile-menu'),'panel' => 'tactile_panel'));
        
        /* hide search */
        $wp_customize->add_setting('tactile_hide_search',array('sanitize_callback' => 'sanitize_tactile_hide_search',));
        function sanitize_tactile_hide_search( $input ) { if ( $input === true ) { return 1; } else { return ''; } }
		$wp_customize->add_control('tactile_hide_search',array('type' => 'checkbox','label' => esc_html__('Hide search','tactile-menu'),'description' => 'When selected, the search function in its entirety will be hidden.','section' => 'tactile_search_section',));
        ...
        $wp_customize->add_control('tactile_search_placeholder',array(
            'type' => 'text',
            'label' => esc_html__('Search field placeholder text','tactile-menu'),
            'description' => esc_html__('If left empty, defaults to "Find something...".','tactile-menu'),
        ...
        $wp_customize->add_control('tactile_search_header_color_opacity',array(
            'type' => 'text',
            'label' => esc_html__('Background color opacity when search active','tactile-menu'),
            'description' => esc_html__('Example: 0.5. If left empty, defaults to opacity setting in "Header" section.','tactile-menu'),
            'section' => 'tactile_search_section',
		));
        ...
        //
        $wp_customize->add_section('tactile_swipe_menu_section',array('title' => esc_html__('Swipe Menu','tactile-menu'),'panel' => 'tactile_panel'));
        
        /* hide swipe menu */
        $wp_customize->add_setting('tactile_hide_swipe_menu',array('sanitize_callback' => 'sanitize_tactile_hide_swipe_menu',));
        function sanitize_tactile_hide_swipe_menu( $input ) { if ( $input === true ) { return 1; } else { return ''; } }
		$wp_customize->add_control('tactile_hide_swipe_menu',array('type' => 'checkbox','label' => esc_html__('Hide swipe menu','tactile-menu'),'description' => 'When selected, the horizontal swipe menu will be hidden.','section' => 'tactile_swipe_menu_section',));
        ...
        $wp_customize->add_control('tactile_swipe_menu_item_size',array(
            'type' => 'text',
            'label' => esc_html__('Swipe menu item size (in pixels)','tactile-menu'),
            'description' => esc_html__('Example: 15. If left empty, defaults to 13.','tactile-menu'),
        ...
        //
        $wp_customize->add_section('tactile_misc_section',array('title' => esc_html__('Misc','tactile-menu'),'panel' => 'tactile_panel'));
    
		/* don't push down site */
        $wp_customize->add_setting('tactile_site_top',array('sanitize_callback' => 'sanitize_tactile_site_top',));
        function sanitize_tactile_site_top( $input ) { if ( $input === true ) { return 1; } else { return ''; } }
		$wp_customize->add_control('tactile_site_top',array('type' => 'checkbox','label' => esc_html__('Do not push down site','tactile-menu'),'description' => 'When unchecked, the header will push down your theme by the amount of its height.','section' => 'tactile_misc_section',));
        ...
        $wp_customize->add_control('tactile_smaller_than',array(
            'type' => 'text',
            'label' => esc_html__('Hide at certain width/resolution','tactile-menu'),
            'description' => wp_kses( __('<strong>Example #1:</strong> If you want to show Tactile on desktop only, enter the values as 0 and 500. <br><br> <strong>Example #2:</strong> If you want to show Tactile on mobile only, enter the values as 500 and 5000. <br><br> Feel free to experiment with your own values to get the result that is right for you. If fields are empty, Tactile will be visible at all browser widths and resolutions. <br><br> Hide Tactile menu if browser width or screen resolution (in pixels) is between...','tactile-menu'), $allowed_html_array ),
        ...
        $wp_customize->add_control('tactile_larger_than',array(
            'type' => 'text',
            'description' => esc_html__('..and:','tactile-menu'),
            'section' => 'tactile_misc_section',
        ));
        ...
        $wp_customize->add_control('tactile_hide_theme_menu',array(
            'type' => 'text',
            'label' => esc_html__('Advanced: Hide theme menu','tactile-menu'),
            'description' => esc_html__('If you have set Tactile to show only at a certain resolution, know the class/ID of your theme menu and would like to hide it when Tactile is visible, enter the class/ID into this field (example: "#my-theme-menu"). Multiple classes/IDs can be entered (separate with comma as you would in a stylesheet).','tactile-menu'),
            'section' => 'tactile_misc_section',
        ));
	...
	// Translation-ready
	//
    function tactile_load_plugin_textdomain() {
        load_plugin_textdomain( 'tactile-menu', FALSE, basename( dirname( __FILE__ ) ) . '/languages/' );
    }
    add_action( 'plugins_loaded', 'tactile_load_plugin_textdomain' );
